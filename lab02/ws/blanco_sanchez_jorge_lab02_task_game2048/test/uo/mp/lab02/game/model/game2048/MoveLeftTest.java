...
/**
 * Clase de prueba para el metodo moveLeft()
...
public class MoveLeftTest {
	 ...
	 * en la posicion 0
	 * When: se invoca al metodo moveLeft()
	 * Then: el tablero tiene en la primera columna la suma de los elementos 
	 * 		consecutivos de las columnas anteriores y el resto 0,al no haber
	 * 		mas elementos repetidos, solo movera los elementos a la izquierda
	 */
	@Test
	 ...
	 * When: se invoca al metodo moveLeft()
	 * Then: el tablero el tablero tiene en las primeras columnas la suma de los elementos 
	 * 		consecutivos(que hayan sido iguales) de las columnas anteriores y el resto 0
	 */
	@Test
	...
	public void testMoveRightHalfMatrix() {
		...
		int[][] expected = {{4,0,0},{4,0,0},{4,4,0}};
	 ...
	 * Then: La matriz es compactada a la izquierda sumado los elemtos iguales
	 * 		y se vuelve a compacatar a la izquierda para terminar,
	 * 		la matriz tendra los elementos sumados en las posiciones
	 * 		mas proximas a la izquierda,al estar llena la matriz resultante
	...
	public void fourSquareMatrixWith() {
		...
		int[][] expected = {{2,4,0,0},{2,4,0,0},{2,4,0,0},{2,4,0,0}};
		game = new Game2048(initial);
		game.moveLeft();
		assertArrayEquals(expected, game.getBoardForTesting());
	}
