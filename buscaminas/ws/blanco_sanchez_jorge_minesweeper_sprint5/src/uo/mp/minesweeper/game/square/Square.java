...
public class Square {
	...
	public void stepOn() throws GameException {
		if(!isOpened() && !isFlagged()) {
			...
			throw new GameException("La casilla seleccionada está abierta o con bandera,"
					+ " no se puede realizar la operación deseada, intentente otra diferente");
		}
	}
	...
	public void flag() throws GameException {
		if(!isOpened() && !isFlagged()) {
			...
			throw new GameException("La casilla está abierta o contiene bandera, vuleve a intentar otra operacion");
		}
	}
	/**
	...
	public void unflag() throws GameException {
		if(!isOpened()&&isFlagged()) {
			...
			throw new GameException("La casilla seleccionada está abierta o con sin bandera,"
					+ " no se puede realizar la operación deseada, intentente otra diferente");
		}
	}
