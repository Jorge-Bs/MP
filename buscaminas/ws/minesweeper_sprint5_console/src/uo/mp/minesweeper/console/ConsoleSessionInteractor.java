...
public class ConsoleSessionInteractor implements SessionInteractor{
	...
	public static final int MAX_MENU_VALUE=5;
	...
	public int askNextOption() throws UserInteractionException{
		...
		try {
			...
			throw new UserInteractionException("caracter no valido");
		}
	}
	...
	public void showFatalErrorMessage(String message) {
		System.out.print("\nSe ha producido un error inesperado: "+ message +", la aplicacion será cerrada,"
				+ " intentalo de nuevo mas tarde, si el problema persigue pongase en contacto con"
				+ " el administrador del programa.");
	}

	/**
	 * Pregunta al usuario el archivo al cual desea importar o exportar el ranking
	 * @return string fileName
	 */
	@Override
	public String askFileName() {
		return Console.readString("Inserte el nombre del fichero: ");
	}
