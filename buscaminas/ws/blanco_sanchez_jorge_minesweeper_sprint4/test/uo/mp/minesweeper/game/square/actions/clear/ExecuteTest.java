...
public class ExecuteTest {
	 ...
	 */
	@Test
	public void allBoardWithoutMines() throws GameException {
	 ...
	 */
	@Test
	public void boardWithMine() throws GameException {
		Square squares[][] = ForTesting.fillBoardClose(4);
		squares[0][0].putMine();
		Board bd = new Board(0,squares);
		bd.stepOn(3, 0);
	 ...
	 */
	@Test
	public void steepOverNumericSquare() throws GameException {
		Square squares[][] = ForTesting.fillBoardClose(4);
		squares[0][0].putMine();
	 ...
	 */
	@Test
	public void steepOnOverThreeSquareBoard() throws GameException {
