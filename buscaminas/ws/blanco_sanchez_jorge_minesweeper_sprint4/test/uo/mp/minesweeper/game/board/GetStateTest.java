...
public class GetStateTest {
	 ...
	 * When: se invoca al metodo 
	 * Then: el array contendra el caracter " "
	 * 
	 */
	@Test
	 ...
	 */
	@Test
	public void getStateMid() throws GameException {
		bd = new Board(0, sq);
		sq[0][0].putMine();
		sq[0][0].flag();
	 ...
	 * When: se invoca al get estate
	 * Then: se devuelve el estado del tablero
	 */
	@Test
	public void getStateNonSquareBoard() {
		bd= new Board(2,3,0);
		char expected[][]= {{'#','#'},{'#','#'},{'#','#'}};
