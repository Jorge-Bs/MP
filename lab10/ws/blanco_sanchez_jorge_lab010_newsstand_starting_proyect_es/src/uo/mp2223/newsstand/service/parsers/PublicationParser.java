...
public class PublicationParser {
	 ...
	 * @throws InvalidLineFormatException 
	 */
	private Frequency getFrecuency(String id) throws InvalidLineFormatException {
		switch(id) {
		case "QUARTERLY":
		...
		default:
			throw new InvalidLineFormatException(lineNumber,"campo de frecuencia invalido");
		}
	}
