...
public class CurrentAcountTransaction extends Transaction{
	...
	public Transaction clone() {
		Transaction clone = new  CurrentAcountTransaction(getDate(), getNumber(), 
				getAmount(), getDescription(), getClientType());
	...
	public boolean equals(Object object) {
		if(object==this) {
			return true;
		}else if(!(object instanceof CurrentAcountTransaction)) {
			return false;
		}else {
			Transaction tr = (Transaction) object;
			return (getNumber().equals(tr.getNumber()) && getDate().equals(tr.getDate()));
		}
	}
