...
public class Collections {
	...
	public static <T> void sort(List<T> list) throws InvalidClassException {
	...
	private static <T> void checkComparableElements(List<T> list) throws InvalidClassException {
		if (! (list.get(0) instanceof Comparable<?>) ) {
			throw new InvalidClassException("No es posible comparar elementos de este tipo de lista");
		}
	}
