...
public class HashCodeTests {
	 ...
	 */
	@ParameterizedTest@MethodSource("createOneList")
	public void nonEmptyTest(List<String> list) {
		list.add(0,"a");
		list.add(1,"b");
		list.add(2,"c");
	...
	public void sameTypeLists(List<String> list1, List<String> list2) {
		list1.add(0,"a");
		list1.add(1,"b");
		list1.add(2,"c");
		list2.add(0,"a");
	 ...
	 */
	@ParameterizedTest@MethodSource("create2ListsSameType")
	public void differentOrderLists(List<String> list1, List<String> list2) {
		list1.add(0,"c");
		list1.add(1,"b");
		list1.add(2,"a");
		list2.add(0,"a");
